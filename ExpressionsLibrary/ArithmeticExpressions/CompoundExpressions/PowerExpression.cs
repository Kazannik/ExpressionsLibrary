...
namespace ExpressionsLibrary.ArithmeticExpressions.CompoundExpressions
{
    ...
    /// </summary>
    class PowerExpression : Expression, IDecimalExpression
    {
        ...
        {
            return LeftExpression.Formula(format: format) + ArithmeticExpression.SymbolSpace + ArithmeticExpression.SymbolPower + ArithmeticExpression.SymbolSpace + RightExpression.Formula(format: format);
        }
